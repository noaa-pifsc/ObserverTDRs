...
```{r}
# Load data
tdr1 <- read_csv("/Volumes/GUTSNGRAVY/ObserverTDRs/LL_DeepSet_DeepTDR.csv", skip = 2, show_col_types = FALSE)
tdr2 <- read_csv("/Volumes/GUTSNGRAVY/ObserverTDRs/LL_DeepSet_ShallowTDR.csv", skip = 2, show_col_types = FALSE)
```
