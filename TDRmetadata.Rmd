...
```{r}
# Load data
tdr1 <- read_csv("/Volumes/GUTSNGRAVY/ObserverTDRs/LL8774_DeepSet_TDR1.csv", skip = 2, show_col_types = FALSE)
tdr2 <- read_csv("/Volumes/GUTSNGRAVY/ObserverTDRs/LL8774_DeepSet_TDR2.csv", skip = 2, show_col_types = FALSE)
```
